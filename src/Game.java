public class Game {
    ...
    //spillet skal opdateres i intervaller og acceptere inout fra spilleren

    public void update(){
        System.out.println("Going to update game");
        if (!gameOver){
    ...
    public static void main(String[] args){
        ...
        //Vi skal bruge at spillet opdatere i regulærer intervaller og acceptere input fra spiller
        //her kalder jeg de forskellige metoder for at vise funktionsdygtighed
